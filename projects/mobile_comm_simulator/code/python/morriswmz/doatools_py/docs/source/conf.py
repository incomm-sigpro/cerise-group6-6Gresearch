...
# documentation.
#
html_theme_options = {"page_width": "1020px"}
...
latex_documents = [
    (master_doc, "doatools.tex", "doatools Documentation", "Mianzhi Wang", "manual"),
]
...
man_pages = [(master_doc, "doatools", "doatools Documentation", [author], 1)]
