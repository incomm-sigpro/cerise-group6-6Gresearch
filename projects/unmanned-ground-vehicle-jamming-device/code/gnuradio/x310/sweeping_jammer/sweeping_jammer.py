...
class sweeping_jammer(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Sweeping Jammer", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Sweeping Jammer")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "sweeping_jammer")
        ...
        self.blocks_vco_c_0 = blocks.vco_c(samp_rate, 157e6, 1)
...
def main(top_block_cls=sweeping_jammer, options=None):
