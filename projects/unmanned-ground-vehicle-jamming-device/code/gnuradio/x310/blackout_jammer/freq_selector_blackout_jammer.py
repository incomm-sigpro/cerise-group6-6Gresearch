...
# Title: Blackout Jammer with Frequency Selection
...
class freq_selector_blackout_jammer(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Blackout Jammer with Frequency Selection", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Blackout Jammer with Frequency Selection")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "freq_selector_blackout_jammer")
...
def main(top_block_cls=freq_selector_blackout_jammer, options=None):
