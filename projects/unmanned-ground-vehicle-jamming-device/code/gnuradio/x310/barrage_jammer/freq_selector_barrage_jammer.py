...
# Title: Barrage Jammer with Frequency Selection
...
class freq_selector_barrage_jammer(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Barrage Jammer with Frequency Selection", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Barrage Jammer with Frequency Selection")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "freq_selector_barrage_jammer")
...
def main(top_block_cls=freq_selector_barrage_jammer, options=None):
